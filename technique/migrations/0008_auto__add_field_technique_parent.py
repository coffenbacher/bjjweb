...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Technique.parent'
        db.add_column('technique_technique', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['technique.Technique']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Technique.parent'
        db.delete_column('technique_technique', 'parent_id')
    ...
    models = {
        ...
        'technique.techniqueimage': {
            ...
            'technique': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': "orm['technique.Technique']"}),
