...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TechniqueImage'
        db.create_table('technique_techniqueimage', (
            ...
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='techniqueimage_related', null=True, to=orm['photologue.PhotoEffect'])),
            ('technique', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['technique.Technique'])),
        ))
        db.send_create_signal('technique', ['TechniqueImage'])

        # Deleting field 'Technique.image'
        db.delete_column('technique_technique', 'image_id')


    def backwards(self, orm):
        # Deleting model 'TechniqueImage'
        db.delete_table('technique_techniqueimage')

        # Adding field 'Technique.image'
        db.add_column('technique_technique', 'image',
    ...
    models = {
        ...
        'technique.technique': {
            'Meta': {'ordering': "['type', 'level']", 'object_name': 'Technique'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'technique.techniqueimage': {
            'Meta': {'object_name': 'TechniqueImage'},
            'crop_from': ('django.db.models.fields.CharField', [], {'default': "'center'", 'max_length': '10', 'blank': 'True'}),
            'date_taken': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'techniqueimage_related'", 'null': 'True', 'to': "orm['photologue.PhotoEffect']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
