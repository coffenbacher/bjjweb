...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TechniqueType.color'
        db.add_column('technique_techniquetype', 'color',
                      self.gf('django.db.models.fields.CharField')(default='green', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TechniqueType.color'
        db.delete_column('technique_techniquetype', 'color')
