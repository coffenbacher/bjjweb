...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TechniqueImage.created_by'
        db.add_column('technique_techniqueimage', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TechniqueImage.created_by'
        db.delete_column('technique_techniqueimage', 'created_by_id')
